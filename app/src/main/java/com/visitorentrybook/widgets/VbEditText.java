...
public class VbEditText extends EditText {
    ...
    public VbEditText(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public VbEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public VbEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initWithAttrs(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.VbEditText, defStyleAttr, defStyleRes);
        int customFontIndex = a.getInt(R.styleable.VbEditText_setEdittextFont, -1);
