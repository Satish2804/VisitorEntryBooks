...
/**
 * Created by Satish on 11/10/2016.
 */
public class VbTextView extends TextView {
    public VbTextView(Context context) {
        super(context);
    }

    public VbTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public VbTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public VbTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initWithAttrs(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.VbTextView, defStyleAttr, defStyleRes);
        int customFontIndex = a.getInt(R.styleable.VbTextView_setFont, -1);
